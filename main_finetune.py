...
def get_args_parser():
    ...
    parser.add_argument('--do_crop', action="store_true", default=False,
                        help='Do CenterCrop for image preprocess')
    parser.add_argument('--do_aug', action="store_true", default=False,
                        help='Do augment for trainning')
    ...
    parser.add_argument('--log_dir', default='./tensor_log_output',
